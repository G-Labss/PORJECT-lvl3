        ...
        <div className="container">
          <div style={{
            ...
            {[
              ...
              { icon: Users, value: lessons.length || 6, label: 'Lesson Packages' },
              { icon: Award, value: currentUser?.ntrpRating || 5.5, label: 'NTRP Rating' },
            ].map(({ value, label }, i) => (
              <div key={label} style={{
          ...
          <div className="grid grid-2" style={{ gap: '4rem', alignItems: 'start' }}>
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                {[
                  { label: 'Email', value: 'khitroudaniil@gmail.com' },
