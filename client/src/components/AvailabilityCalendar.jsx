...
// dayOfWeek mapping: our display Mon=0...Sun=6, JS Date getDay() Sun=0,Mon=1...Sat=6
const DISPLAY_TO_JS_DOW = [1, 2, 3, 4, 5, 6, 0];
                ...
                {daySlots.length === 0 ? (
                  ...
                  return (
                    <button
                      ...
                      title={booked ? 'Already booked' : past ? 'Past date' : `Book ${formatTime(slot.startTime)}`}
                    >
