        ...
        <Modal isOpen={isOpen} onClose={onClose} title={lesson.title}>
            <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.75rem', marginBottom: '2rem' }}>
                    {[
                        { icon: Clock, label: 'Duration', value: `${lesson.duration} min` },
                        { icon: DollarSign, label: 'Price', value: `$${lesson.price}` },
                        { icon: Users, label: 'Class Size', value: `Max ${lesson.maxStudents}` },
